    ...
    int       nCmdShow)
{
    ...
    return Game003Player::createAndRun();
}

int Game003Player::createAndRun(void)
{
    Game003Player *host = Game003Player::sharedInstance();
    int ret = host->run();
    Game003Player::purgeSharedInstance();
    return ret;
}

Game003Player *Game003Player::s_sharedInstance = NULL;

Game003Player *Game003Player::sharedInstance(void)
{
    if (!s_sharedInstance)
    {
        s_sharedInstance = new Game003Player();
    }
    return s_sharedInstance;
}

void Game003Player::purgeSharedInstance(void)
{
    if (s_sharedInstance)
    {
...
Game003Player::Game003Player(void)
: m_app(NULL)
, m_hwnd(NULL)
, m_exit(TRUE)
...
int Game003Player::run(void)
{
    ...
    do
    {
        ...
        SetWindowTextA(m_hwnd, "game003-player");
...
void Game003Player::loadProjectConfig(void)
{
    vector<string> args;
...
void Game003Player::createViewMenu(void)
{
...
void Game003Player::updateMenu(void)
{
    HMENU menu = GetMenu(m_hwnd);
    HMENU viewMenu = GetSubMenu(menu, 1);
...
void Game003Player::updateWindowTitle(void)
{
}

void Game003Player::relaunch(void)
{
...
void Game003Player::writeDebugLog(const char *log)
{
...
// menu callback
void Game003Player::onFileOpenProject(void)
{
...
void Game003Player::onFileCreateProjectShortcut(void)
{
    ...
    if (SUCCEEDED(hres))
    {
        ...
        psl->SetDescription(L"Game003Player");
...
void Game003Player::onFileProjectConfig(void)
{
...
void Game003Player::onFileRelaunch(void)
{
    relaunch();
}

void Game003Player::onFileExit(void)
{
    DestroyWindow(m_hwnd);
}

void Game003Player::onViewChangeFrameSize(int viewMenuID)
{
...
void Game003Player::onViewChangeOrientation(int viewMenuID)
{
    bool isLandscape = m_project.isLandscapeFrame();
...
void Game003Player::onViewChangeZoom(int scaleMode)
{
    float scale = 1.0f;
...
void Game003Player::onHelpAbout(void)
{
    DialogBox(GetModuleHandle(NULL), MAKEINTRESOURCE(IDD_ABOUTBOX), m_hwnd, AboutDialogCallback);
}

// windows callback
LRESULT Game003Player::WindowProc(UINT message, WPARAM wParam, LPARAM lParam, BOOL* pProcessed)
{
    int wmId, wmEvent;
    Game003Player *host = Game003Player::sharedInstance();
...
INT_PTR CALLBACK Game003Player::AboutDialogCallback(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
